...
public final class Translate extends YandexTranslatorAPI {
  ...
  // Método encargado de traducir una palabra de un idioma a otro.
  public String traducirPalabra(String texto)
  {
    ...
    try
    {
        ...
        traduccion = 
                Translate.execute(texto, Language.ENGLISH, Language.SPANISH);
    }
    catch(Exception e)
    {
        return "";
  ...
  // Traduce de un lenguaje a otro recibiéndolo como parámetro.
  public String traducirPalabra(String texto, String l1, String l2)
  {
    String traduccion = "";
    try
    {
        Translate.setKey(ApiKeys.YANDEX_API_KEY);
        traduccion = 
                Translate.execute(texto, Language.fromString(l1), Language.fromString(l2));
    }
    catch(Exception e)
    {
        return "";
